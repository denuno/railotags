<cfcomponent displayname="TestInstall"  extends="mxunit.framework.TestCase">
	...
	<cfimport taglib="/cfjasperreport/src/tag/cfjasperreport" prefix="jr" />
	...
	<cffunction name="setUp" returntype="void" access="public">
		...
		<cftry>
			<jr:jasperreport jrxml="#datapath#/test.jrxml" exportfile="/tmp/delme.pdf" exporttype="pdf"/>
			<cfcatch>
				<cfset debug(cfcatch) />
				<cfif findNoCase("is not defined in directory",cfcatch.message) OR
					...
					<cfset install = createObject("component","cfjasperreport.tests.extension.TestInstall") />
					<cfset install.setUp() />
					<cfset install.testInstallDevCustomTag() />
				</cfif>
			</cfcatch>
		</cftry>
		<cfquery datasource="jasperreport">
		...
		<cfquery datasource="jasperreport">
			INSERT INTO `people` VALUES (10001,'Georgi','Facello'),(10002,'Georgi','Facello'),(10003,'Georgi','Facello')
		</cfquery>
	</cffunction>
	...
	<cffunction name="testjasperreportsTagBorrowersPdf">
	...
	<cffunction name="testjasperreportsTagPdfDSN">
