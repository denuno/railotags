...
<cf_fspdf action="compile" jrxml="#getDirectoryFromPath(getCurrentTemplatePath())#/reports/OrdersReport.jrxml" resultsVar="subreport">
<cfset reportparams["OrdersReport"] = subreport />
<cfset JRParameter = createObject("java","net.sf.fspdfs.engine.JRParameter") />
<cfset JRXPathQueryExecuterFactory = createObject("java","net.sf.fspdfs.engine.query.JRXPathQueryExecuterFactory") />
