...
import net.sf.fspdfs.engine.JRComponentElement;
import net.sf.fspdfs.engine.JRException;
import net.sf.fspdfs.engine.JRImageRenderer;
import net.sf.fspdfs.engine.JRPrintElement;
import net.sf.fspdfs.engine.JRPrintImage;
import net.sf.fspdfs.engine.JRRenderable;
import net.sf.fspdfs.engine.JRRuntimeException;
import net.sf.fspdfs.engine.component.BaseFillComponent;
import net.sf.fspdfs.engine.component.FillPrepareResult;
import net.sf.fspdfs.engine.fill.JRFillCloneFactory;
import net.sf.fspdfs.engine.fill.JRFillCloneable;
import net.sf.fspdfs.engine.fill.JRFillObjectFactory;
import net.sf.fspdfs.engine.fill.JRTemplateImage;
import net.sf.fspdfs.engine.fill.JRTemplatePrintImage;
import net.sf.fspdfs.engine.type.EvaluationTimeEnum;
import net.sf.fspdfs.engine.type.OnErrorTypeEnum;
 ...
 * @version $Id: FillAxisChart.java 3611 2010-03-23 12:09:17Z teodord $
 */
