...
import net.sf.fspdfs.engine.JRGenericElementType;
...
import net.sf.fspdfs.engine.fill.JRTemplateGenericElement;
import net.sf.fspdfs.engine.fill.JRTemplateGenericPrintElement;
...
public class FillBarChart extends BaseFillComponent implements JRFillCloneable
{
	...
	public static final JRGenericElementType CHART_PRINT_TYPE = 
		new JRGenericElementType("http://fspdfs.sourceforge.net/openflashchart", "chart");
