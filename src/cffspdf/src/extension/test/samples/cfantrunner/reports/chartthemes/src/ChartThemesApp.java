...
import net.sf.fspdfs.chartthemes.simple.AegeanSettingsFactory;
import net.sf.fspdfs.chartthemes.simple.EyeCandySixtiesSettingsFactory;
import net.sf.fspdfs.chartthemes.simple.SimpleSettingsFactory;
import net.sf.fspdfs.chartthemes.simple.XmlChartTheme;
...
import net.sf.fspdfs.engine.data.JRCsvDataSource;
 ...
 * @version $Id: ChartThemesApp.java 3704 2010-04-07 13:09:46Z teodord $
 */
public class ChartThemesApp extends AbstractSampleApp
{
	...
	public void themes() throws JRException
	{
		...
		XmlChartTheme.saveSettings(
			...
			new File("src/net/sf/fspdfs/chartthemes/simple/simple.jrctx")
			);
		XmlChartTheme.saveSettings(
			EyeCandySixtiesSettingsFactory.createChartThemeSettings(), 
			new File("src/net/sf/fspdfs/chartthemes/simple/eye.candy.sixties.jrctx")
			);
		XmlChartTheme.saveSettings(
			AegeanSettingsFactory.createChartThemeSettings(), 
			new File("src/net/sf/fspdfs/chartthemes/simple/aegean.jrctx")
			);
