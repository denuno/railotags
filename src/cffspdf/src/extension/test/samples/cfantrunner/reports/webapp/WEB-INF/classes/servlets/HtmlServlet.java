...
import net.sf.fspdfs.engine.export.JRHtmlExporter;
import net.sf.fspdfs.engine.export.JRHtmlExporterParameter;
import net.sf.fspdfs.engine.util.JRLoader;
import net.sf.fspdfs.j2ee.servlets.ImageServlet;
...
public class HtmlServlet extends HttpServlet
{
		...
		) throws IOException, ServletException
	{
		...
		try
		{
			...
			fspdf fspdf = (fspdf)JRLoader.loadObject(reportFile.getPath());
		...
		catch (JRException e)
		{
			out.println("<html>");
			out.println("<head>");
			out.println("<title>fspdfs - Web Application Sample</title>");
			out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"../stylesheet.css\" title=\"Style\">");
			out.println("</head>");
			
			out.println("<body bgcolor=\"white\">");

			out.println("<span class=\"bnew\">fspdfs encountered this error :</span>");
			out.println("<pre>");
