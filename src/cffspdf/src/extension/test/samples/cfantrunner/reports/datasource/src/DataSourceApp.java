...
import net.sf.fspdfs.engine.data.JRBeanArrayDataSource;
import net.sf.fspdfs.engine.data.JRBeanCollectionDataSource;
import net.sf.fspdfs.engine.data.JRTableModelDataSource;
