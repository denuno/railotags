...
import net.sf.fspdfs.engine.JRImageRenderer;
import net.sf.fspdfs.engine.JRPrintImage;
import net.sf.fspdfs.engine.JRPrintLine;
import net.sf.fspdfs.engine.JRPrintPage;
import net.sf.fspdfs.engine.JRPrintText;
import net.sf.fspdfs.engine.JasperPrint;
import net.sf.fspdfs.engine.base.JRBasePrintImage;
import net.sf.fspdfs.engine.base.JRBasePrintLine;
import net.sf.fspdfs.engine.base.JRBasePrintPage;
import net.sf.fspdfs.engine.base.JRBasePrintText;
import net.sf.fspdfs.engine.design.JRDesignStyle;
import net.sf.fspdfs.engine.export.JRPrintServiceExporter;
import net.sf.fspdfs.engine.export.JRPrintServiceExporterParameter;
import net.sf.fspdfs.engine.type.HorizontalAlignEnum;
import net.sf.fspdfs.engine.type.ScaleImageEnum;
	...
	private static JasperPrint getJasperPrint() throws JRException
	{
		...
		image.setRenderer(
			JRImageRenderer.getInstance(
				JRLoader.loadBytesFromLocation("fspdfs.png")
				)
			);
		...
		text.setFontSize(18);
		text.setText("fspdfs Project Description");
		...
		text.setFontSize(14);
		text.setText(
			"fspdfs is a powerful report-generating tool that has the ability to deliver rich content onto the screen, to the printer or into PDF, HTML, XLS, CSV or XML files.\n\n" +
