...
import net.sf.fspdfs.engine.JRParameter;
...
import net.sf.fspdfs.engine.util.SimpleFileResolver;
...
public class TableOfContentsApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		fspdf fspdf = (fspdf)JRLoader.loadObject("build/reports/TableOfContentsReport.jasper");

		JasperPrint jasperPrint = JasperFillManager.fillReport(fspdf, parameters, getDemoHsqldbConnection());
