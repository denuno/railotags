...
import net.sf.fspdfs.engine.JasperCompileManager;
...
import net.sf.fspdfs.engine.design.JRDesignBand;
import net.sf.fspdfs.engine.design.JRDesignExpression;
import net.sf.fspdfs.engine.design.JRDesignField;
import net.sf.fspdfs.engine.design.JRDesignFrame;
import net.sf.fspdfs.engine.design.JRDesignGroup;
import net.sf.fspdfs.engine.design.JRDesignLine;
import net.sf.fspdfs.engine.design.JRDesignParameter;
import net.sf.fspdfs.engine.design.JRDesignQuery;
import net.sf.fspdfs.engine.design.JRDesignSection;
import net.sf.fspdfs.engine.design.JRDesignStaticText;
import net.sf.fspdfs.engine.design.JRDesignStyle;
import net.sf.fspdfs.engine.design.JRDesignTextField;
import net.sf.fspdfs.engine.design.JRDesignVariable;
import net.sf.fspdfs.engine.design.JasperDesign;
...
import net.sf.fspdfs.engine.type.CalculationEnum;
import net.sf.fspdfs.engine.type.HorizontalAlignEnum;
import net.sf.fspdfs.engine.type.ModeEnum;
import net.sf.fspdfs.engine.type.PositionTypeEnum;
import net.sf.fspdfs.engine.type.ResetTypeEnum;
